...
#
Set-Variable -Name EXPECTED_JDK_VERSION -Value "11"
...
Set-Variable -Name EXTERNAL_MODULES -Value @(
    ...
    "$REPO\org\openjfx\javafx-base\11.0.2\javafx-base-11.0.2.jar",
    "$REPO\org\openjfx\javafx-controls\11.0.2\javafx-controls-11.0.2.jar",
    "$REPO\org\openjfx\javafx-fxml\11.0.2\javafx-fxml-11.0.2.jar",
    "$REPO\org\openjfx\javafx-graphics\11.0.2\javafx-graphics-11.0.2.jar",
    "$REPO\org\openjfx\javafx-base\11.0.2\javafx-base-11.0.2-$PLATFORM.jar",
    "$REPO\org\openjfx\javafx-controls\11.0.2\javafx-controls-11.0.2-$PLATFORM.jar",
    "$REPO\org\openjfx\javafx-fxml\11.0.2\javafx-fxml-11.0.2-$PLATFORM.jar",
    "$REPO\org\openjfx\javafx-graphics\11.0.2\javafx-graphics-11.0.2-$PLATFORM.jar"
)
